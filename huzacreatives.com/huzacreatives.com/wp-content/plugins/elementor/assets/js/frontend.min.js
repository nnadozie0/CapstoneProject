    ...
    [819], {
            ...
            o(o.S + o.F * !n(694)((function(e) {
                ...
                from: function from(e) {
                    var t, n, o, c, h = r(e),
                        ...
                        p = 0,
                        y = u(h);
                    if (m && (g = i(g, v > 2 ? arguments[2] : void 0, 2)), null == y || f == Array && s(y))
                        for (n = new f(t = l(h.length)); t > p; p++) d(n, p, m ? g(h[p], p) : h[p]);
                    else
                        for (c = y.call(h), n = new f; !(o = c.next()).done; p++) d(n, p, m ? a(c, g, [o.value, p], !0) : o.value);
                    return n.length = p, n
                }
            })
        },
                ...
                u = function(e) {
                    ...
                    return (0, r.default)(BackgroundVideo, [{
                        ...
                        value: function prepareYTVideo(e, t) {
                            ...
                            o.background_privacy_mode && (a.host = "https://www.youtube-nocookie.com", a.origin = window.location.hostname), i.addClass("elementor-loading elementor-invisible"), this.player = new e.Player(this.elements.$backgroundVideoEmbed[0], a)
                        }
                    }, {
                        key: "activate",
                        value: function activate() {
        ...
        3896: (e, t, n) => {
            ...
            e.exports = elementorModules.ViewModule.extend({
                    ...
                    if (n || i || o || r) {
                        if (l.$header = t("<header>", {
                            ...
                            d.on("click", (function(e) {
                                ...
                                class: s.shareMenu
                            }).append(d), l.$iconShare.add(l.$shareMenu).on("click", this.toggleShareMenu), l.$header.append(l.$iconShare, l.$shareMenu), this.$buttons = this.$buttons.add(l.$iconShare)
                        }
                ...
                setSlideshowContent: function setSlideshowContent(e) {
                    ...
                    })), v.append(n, t), this.$buttons = this.$buttons.add(n).add(t)), c && (this.elements.$footer = this.getSlideshowFooter(), v.append(this.elements.$footer)), this.setSettings("hideUiTimeout", ""), v.on("click mousemove keypress", this.showLightboxUi);
                    var m = this.getModal();
                    m.setMessage(v);
                    var p = m.onShow;
                    m.onShow = (0, r.default)(o.default.mark((function _callee() {
                        var r, a;
        ...
        6248: e => {
            var t = function(e) {
                ...
                return GeneratorFunction.prototype = m.constructor = GeneratorFunctionPrototype, GeneratorFunctionPrototype.constructor = GeneratorFunction, GeneratorFunction.displayName = define(GeneratorFunctionPrototype, s, "GeneratorFunction"), e.isGeneratorFunction = function(e) {
                ...
                }, defineIteratorMethods(m), define(m, s, "Generator"), m[r] = function() {
                    return this
                }, m.toString = function() {
